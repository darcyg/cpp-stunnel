...
public:
    ...
    client():mode("R"), stunnelserverip("127.0.0.1"), stunnelserverport(8323), forwardport(8325), targetip("127.0.0.1"), targetport(22), p_ios((asio::io_service*)NULL), p_sock((tcp::socket*)NULL){
    }
    ...
    void setupTunnel() {
        ...
        tcp::resolver::query targetquery(stunnelserverip, boost::lexical_cast<string>(stunnelserverport));
